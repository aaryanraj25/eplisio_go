    ...
    return Scaffold(
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: Obx(() {
            return controller.isLoading && controller.statsLoaded == false
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Combined clock in-out display
              Obx(() {
                final clockIn = controller.clockInTime;
                final clockOut =
                    controller.isClockedIn ? '--:--' : controller.clockOutTime;
              ...
              Obx(() {
                ...
                final isClockedIn = controller.isClockedIn;

                return ElevatedButton(
                  onPressed: isLoading ? null : controller.toggleClockInOut,
